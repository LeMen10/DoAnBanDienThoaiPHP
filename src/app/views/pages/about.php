        ...
        <div class="row">
            ...
            <div class="col-lg-5 col-md-10">
                <div class="about-image-wrap">
                    <img class="img-full" src="public/img/product-about.jpg" alt="About Us" />
                </div>
            </div>
            <!-- About Image End -->
        </div>
        ...
        <div class="row no-gutters">
                ...
                <div class="limupa-counter white-smoke-bg">
                    <div class="container">
                        <div class="counter-img">
                            <img src="public/img/about-us/icon-1.png" alt="">
                        </div>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="limupa-counter gray-bg">
                    <div class="counter-img">
                        <img src="public/img/about-us/icon-2.png" alt="">
                    </div>
                    <div class="counter-info">
                        <div class="counter-number">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="limupa-counter white-smoke-bg">
                    <div class="counter-img">
                        <img src="public/img/about-us/icon-3.png" alt="">
                    </div>
                    <div class="counter-info">
                        <div class="counter-number">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="limupa-counter gray-bg">
                    <div class="counter-img">
                        <img src="public/img/about-us/icon-4.png" alt="">
                    </div>
                    <div class="counter-info">
                        <div class="counter-number">
                            <h3 class="counter">2169</h3>
