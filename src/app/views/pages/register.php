        ...
        <div class="login-form">
            ...
            <div class="row">
                <div class="col-md-6 col-12 mb-20">
                    ...
                    <div class="error" id="error_firstName">First Name không hợp lệ.(Không chứa ký số và các ký tự đặc
                        biệt)</div>
                </div>
                <div class="col-md-6 col-12 mb-20">
                    ...
                    <div class="error_login" id="error_lastName">Last Name không hợp lệ.(Không chứa ký số và các ký tự
                        đặc biệt)</div>
                </div>
                ...
                <div class="col-md-6 mb-20">
                    ...
                    <input name="Confirm_Password" id="Confirm_Password" class="mb-0" type="password"
